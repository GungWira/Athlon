...
export default function JoinOwner() {
  return (
    <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        className="pl-10 pr-4 py-2 w-full border rounded-md appearance-none focus:outline-none focus:ring-2 focus:ring-indigo-500"
                      >
