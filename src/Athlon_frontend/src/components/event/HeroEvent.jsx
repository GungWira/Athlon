    ...
    <section className="relative overflow-hidden mt-8 rounded-xl bg-indigo-600">
      <div className="py-20 relative z-10">
        <div className="text-center text-white mb-6">
          <h2 className="text-4xl md:text-5xl font-bold mb-5">Find Event</h2>
          <p className="text-base opacity-80 mt-4">
            Cari dan ikuti berbagai event olahraga terbaik yang ada dan sesuai
            dengan bakat kamu disini!
          </p>
        </div>
